...
plot "/tmp/ledgerplot/ledgeroutput1.tmp" using 1:2 with filledcurves x1 title "Assets" linecolor rgb "light-green", "/tmp/ledgerplot/ledgeroutput2.tmp" using 1:2 with filledcurves y1=0 title "Liabilities" linecolor rgb "light-salmon", "/tmp/ledgerplot/ledgeroutput3.tmp" using 1:2 with lines title "NetWorth" linecolor rgb "dark-blue", 625000 title "4%-amount for 25k" linecolor rgb "purple" linewidth 3
