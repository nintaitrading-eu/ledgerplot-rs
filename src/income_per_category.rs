pub mod income_per_category
{
    ...
    const FILE_OUTPUT1: &'static str = "income_per_category.dat";
    const FILE_OUTPUT_FINAL: &'static str = "income_per_category.png"; // As defined in the gnu file.
    ...
    ) -> Result<(), error::ApplicationError>
    {
        for year in astartyear .. aendyear + 1
        {
            ...
            Command::new("gnuplot")
                .arg("/usr/local/share/ledgerplot/gp_income_per_category.gnu")
                .status()?;
